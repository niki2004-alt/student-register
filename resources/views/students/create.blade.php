    ...
    <div class="p-5 bg-light border rounded shadow row justify-content-center">
        ...
        <form action="{{ route('students.store') }}" class="row g-3 " method="POST">
            ...
            <div class="col-md-6 fs-6 fw-bold">
                <label>Name</label>
                <input type="text" name="name" class="form-control border-primary" value="{{ old('name') }}" required>
                @error('name')
            ...
            <div class="col-md-6 fs-6 fw-bold">
                <label>Year</label>
                <input type="text" name="year" class="form-control border-primary" value="{{ old('year') }}" required>
                @error('year')
                <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="col-md-6 fs-6 fw-bold">
                ...
                <select name="major" id="major" class="form-control border-primary" required>
